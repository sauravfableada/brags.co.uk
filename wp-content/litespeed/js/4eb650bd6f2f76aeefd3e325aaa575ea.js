...
reset_discounted_plan_data($subscription_plan)
jQuery(document).trigger('pms_discount_error')}})}else{reset_discounted_plan_data($subscription_plan)
jQuery(document).trigger('pms_discount_error')}})
...
return_value=!0}
return return_value}
function reset_discounted_plan_data($subscription_plan){if(typeof $subscription_plan.data('price-original')!='undefined')
...
$subscription_plan.data('is-full-discount',!1)}})
;