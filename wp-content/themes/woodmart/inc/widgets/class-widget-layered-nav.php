...
class WOODMART_Widget_Layered_Nav extends WPH_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( ! in_array( 'all', $category, true ) && property_exists( $current_cat, 'term_id' ) && ! in_array( $current_cat->term_id, $category, true ) && ! in_array( $current_cat->parent, $category, true ) ) {
			return;
		}
