	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} :is(.wd-breadcrumbs,.yoast-breadcrumb,.rank-math-breadcrumb,.aioseo-breadcrumbs)',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} :is(.wd-breadcrumbs,.yoast-breadcrumb,.rank-math-breadcrumb,.aioseo-breadcrumbs)' => '--wd-link-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} :is(.wd-breadcrumbs,.yoast-breadcrumb,.rank-math-breadcrumb,.aioseo-breadcrumbs)' => '--wd-bcrumb-delim-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} :is(.wd-breadcrumbs,.yoast-breadcrumb,.rank-math-breadcrumb,.aioseo-breadcrumbs)' => '--wd-link-color-hover: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} :is(.wd-breadcrumbs,.yoast-breadcrumb,.rank-math-breadcrumb,.aioseo-breadcrumbs)' => '--wd-bcrumb-color-active: {{VALUE}}',
				),
			)
		);
