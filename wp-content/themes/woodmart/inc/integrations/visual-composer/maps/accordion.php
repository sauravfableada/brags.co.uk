		...
		return array(
			...
			'params'          => array(
				...
				array(
					...
					'selectors'        => array(
						'{{WRAPPER}} > .wd-accordion-item > .wd-accordion-title > .wd-accordion-opener' => array(
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	 ...
	 */
	class WPBakeryShortCode_woodmart_accordion extends WPBakeryShortCodesContainer {} // phpcs:ignore PEAR.NamingConventions, Universal.Files, WordPress.NamingConventions
}
