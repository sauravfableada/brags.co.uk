...
function add_dokan_dg_field_old( $post ) {
    ...
    <div class="dokan-form-simple-barcode-field">
        ...
        <div class="dokan-form-group" id="sds_document_field" style="display: <?php echo ($is_dangerous_good === 'yes') ? 'block' : 'none'; ?>;">
            ...
            <?php if (!empty($sds_document)) : ?>
                <p><strong>Current SDS:</strong> <a href="<?php echo esc_url($sds_document); ?>" target="_blank">View Document</a></p>
            <?php else : ?>
...
function add_dokan_dg_field( $post ) {
    ...
    <div class="dokan-form-simple-barcode-field">
        ...
        <div class="dokan-form-group" id="sds_document_section" style="display: <?php echo ($is_dangerous_good === 'yes') ? 'block' : 'none'; ?>;">
            <label for="sds_document"><?php _e( 'Upload SDS Document (PDF Only)', 'dokan-lite' ); ?></label>
