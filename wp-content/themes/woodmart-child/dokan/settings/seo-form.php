...
<form method="post" id="dokan-store-seo-form"  action="" class="dokan-form-horizontal">
    ...
    <div class="dokan-form-group">
        <label class="dokan-w3 dokan-control-label" for="dokan-seo-og-title"><?php _e( 'Social Media Title :', 'dokan' ); ?></label>
        <div class="dokan-w5 dokan-text-left">
    ...
    <div class="dokan-form-group">
        <label class="dokan-w3 dokan-control-label" for="dokan-seo-og-desc"><?php _e( 'Social Media Description :', 'dokan' ); ?></label>
        <div class="dokan-w5 dokan-text-left">
    ...
    ?>
    <div class="dokan-form-group ">
        <label class="dokan-w3 dokan-control-label" for="dokan-seo-og-image"><?php _e( 'Social Media Image :', 'dokan' ); ?></label>
        <div class="dokan-w5 dokan-gravatar dokan-seo-image">
            ...
            <div class="gravatar-button-area <?php echo $og_image ? ' dokan-hide' : ''; ?>">
                <a href="#" class="dokan-gravatar-drag dokan-btn dokan-btn-default dokan-left"><i class="fas fa-cloud-upload-alt"></i> <?php _e( 'Upload Photo', 'dokan' ); ?></a>
            </div>
        </div>
    </div>
