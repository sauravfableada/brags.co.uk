                ...
                <?php if ( apply_filters( 'dokan_can_post', true ) ) : ?>
                    <?php if ( dokan_is_seller_enabled( get_current_user_id() ) ) : ?>
                        <form class="dokan-product-edit-form" role="form" method="post" id="post">
                                            ...
                                            <div class="dokan-form-group">
                                                ...
                                                <select name="product_type" class="dokan-form-control" id="product_type">
                                                    <?php foreach ( $product_types as $key => $value ) :
                                                        ...
                                                        if($value=='Simple'){
                                                            $value = 'Single Listing';
                                                        }
                                                        if($value=='Variable'){
                                                            $value = 'Listing with Variations';
                                                        }
                                                        ?>
                                ...
                                <div class="content-half-part featured-image">
                                    ...
                                    <div class="dokan-feat-image-upload dokan-new-product-featured-img">
                                        ...
                                        <div class="instruction-inside<?php echo esc_attr( $instruction_class ); ?>">
                                            ...
                                            <a href="#" class="dokan-feat-image-btn btn btn-sm"><?php esc_html_e( 'Upload your first Product Image here', 'dokan-lite' ); ?></a>
                                        </div>
                            ...
                            <div class="dokan-form-group">
                                <label for="_key_selling_points" class="form-label"><?php esc_html_e( 'Key Selling Points', 'dokan-lite' ); ?></label>
                                <textarea id="_key_selling_points" name="_key_selling_points" class="dokan-form-control" rows="4" placeholder="<?php esc_attr_e( 'Enter up to 4 key selling points (One per line, max 250 characters each)', 'dokan-lite' ); ?>"><?php echo esc_textarea( get_post_meta( $post->ID, '_key_selling_points', true ) ); ?></textarea>
                                <p class="help"><?php esc_html_e( 'Each point should be on a new line.', 'dokan-lite' ); ?></p>
                            </div>
                            ...
                            <input type="hidden" name="dokan_update_product" value="<?php esc_attr_e( 'SUBMIT FOR REVIEW', 'dokan-lite' ); ?>"/>
                            <input type="submit" name="dokan_update_product" id="publish" class="dokan-btn dokan-btn-theme dokan-btn-lg dokan-right" value="<?php esc_attr_e( 'SUBMIT FOR REVIEW', 'dokan-lite' ); ?>"/>
