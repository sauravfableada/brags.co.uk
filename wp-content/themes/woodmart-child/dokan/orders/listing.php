        ...
        <table class="dokan-table dokan-table-striped">
            ...
            foreach ( $user_orders as $order ) { // phpcs:ignore
                ...
                <tr>
                    ...
                    <td class="dokan-order-statu" data-title="<?php esc_attr_e( 'Status', 'dokan-lite' ); ?>">
                    ...
                    <?php if ( function_exists( 'dokan_get_order_shipment_current_status' ) && 'on' === $allow_shipment && $wc_shipping_enabled ) : ?>
                        <td class="dokan-order-shipping-statusyyy" data-title="<?php esc_attr_e( 'Shipping Status', 'dokan-lite' ); ?>">
