<div class="dokan-panel dokan-panel-default">
    <div class="dokan-panel-heading">
        <strong><?php esc_html_e( 'Invoice', 'dokan' ); ?></strong>
    </div>
    <div class="dokan-panel-body" id="dokan-order-shipping-status-tracking-panel">
        <div class="dokan-panel-body" id="dokan-order-invoice-summary">
            <table class="dokan-table dokan-table-striped">
                ...
                <tbody>
                    <?php 
                        ...
                        ?>
                        <tr>
                            <td><?php echo esc_html( $vat_rate_display ); ?></td>
                            <td><?php echo esc_html( $customer_type ?: 'Individual' ); ?></td>
                            
                            <td>
                                <?php if ( $invoice && $automated != 'yes' ) :
                                    $url = wp_upload_dir()['baseurl'] . '/' . basename( $invoice ); ?>
                                    <a href="<?php echo esc_url( $url ); ?>" class="dokan-btn dokan-btn-sm dokan-btn-default" target="_blank">View</a>
                                <?php else : ?>
                                    <a href="javascript:void(0)" class="dokan-btn dokan-btn-sm dokan-btn-default upload-invoice-btn" data-order-id="<?php echo esc_attr( $order_id ); ?>">Upload</a>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php if ( $invoice && $automated === 'yes' ) :
                                    $url = wp_upload_dir()['baseurl'] . '/' . basename( $invoice ); ?>
                                    <a href="<?php echo esc_url( $url ); ?>" class="dokan-btn dokan-btn-sm dokan-btn-success" target="_blank">View</a>
                                <?php elseif ( $vat_number!="" && $invoice=='') : ?>
                                    <a href="javascript:void(0)" class="dokan-btn dokan-btn-sm dokan-btn-success automate-invoice-btn" data-order-id="<?php echo esc_attr( $order_id ); ?>">Automate</a>
                                <?php else : ?>
                                    -
                                <?php endif; ?>
                            </td>
                            <td><?php echo esc_html( $invoice_status ?: 'Not Generated' ); ?></td>
                        </tr>
                    <?php  ?>
                </tbody>
            </table>
