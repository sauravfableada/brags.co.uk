...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<?php if ( $tabs ) : ?>
		<div class="col-12 col-md-6 col-register-text">
			...
			//  echo '<div class=""><a href="' . home_url('/become-a-bragger/') . '" class="btn custom-affiliate-button" style="margin-top:30px;display:block;padding:15px;">Become a bragger</a></div>';
			//  echo '<div class=""><a href="' . home_url('/brand-owner-registration/') . '" class="btn custom-affiliate-button" style="margin-top:30px;display:block;padding:15px;">Register your Brand</a></div>';
			?>
		</div>
	<?php endif ?>
