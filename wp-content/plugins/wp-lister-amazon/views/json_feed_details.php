...
<body class="wp-core-ui">
    ...
    <div class="tab-content wpla_tab_feed_content_wrapper">
        ...
        <table class="info-table" style="width: 400px;">
            <tr>
                <th>Product Type</th>
                <td><?php echo esc_html( $wpl_feed->product_type ); ?></td>
            </tr>
            <tr>
                <th>Created</th>
                <td>
                    <?php echo esc_html( $wpl_feed->date_created ); ?>
                    ( <?php echo esc_html( human_time_diff( strtotime($wpl_feed->date_created.' UTC') ) ); ?> ago )
                </td>
            </tr>
            <?php if ( $wpl_feed->SubmittedDate ) : ?>
            <tr>
                <th>Submitted</th>
                <td><?php echo esc_html( $wpl_feed->SubmittedDate ); ?>
