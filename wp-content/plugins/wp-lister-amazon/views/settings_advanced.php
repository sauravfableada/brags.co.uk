					...
					<div class="postbox" id="UninstallSettingsBox">
						...
						<div class="inside">
							...
							<p class="desc" style="display: block;">
								...
								<!-- ## BEGIN PRO ## -->
								<br><br>
								<?php echo __( 'Please deactivate your license first.', 'wp-lister-for-amazon' ); ?>
								<!-- ## END PRO ## -->
							</p>
				...
				<div class="meta-box-sortables ui-sortable">
					...
					<div class="postbox" id="UISettingsBox">
						...
						<div class="inside">
							...
							<select id="wpl-default_matcher_selection" name="wpla_default_matcher_selection" class=" required-entry select">
								...
								<option value="ean"   <?php if ( $wpl_default_matcher_selection == 'ean' ):   ?>selected="selected"<?php endif; ?>><?php echo __( 'EAN', 'wp-lister-for-amazon' ) ?></option>
					...
					<div class="postbox" id="RepricingSettingsBox">
						...
						<div class="inside">
							...
							<label for="wpl-enable_auto_repricing" class="text_label">
								<?php echo __( 'Enable automatic repricing', 'wp-lister-for-amazon' ) ?>
							...
							<select id="wpl-enable_auto_repricing" name="wpla_enable_auto_repricing" class=" required-entry select">
								<option value="0" <?php if ( $wpl_enable_auto_repricing == '0' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'No', 'wp-lister-for-amazon' ); ?> (<?php _e('default', 'wp-lister-for-amazon' ); ?>)</option>
								<option value="1" <?php if ( $wpl_enable_auto_repricing == '1' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Yes', 'wp-lister-for-amazon' ); ?></option>
							</select>
							<p class="desc" style="display: block;">
								<?php echo __( 'Please test the manual repricing tool properly before enabling this option.', 'wp-lister-for-amazon' ); ?>
							</p>
					        <!-- ## END PRO ## -->
							...
							<input type="text" name="wpla_repricing_margin" id="wpl-text-repricing_margin" value="<?php echo esc_attr($wpl_repricing_margin); ?>" placeholder="0.00" class="text_input" />
							<p class="desc" style="display: block;">
                            ...
                            <input type="text" name="wpla_repricing_shipping" id="wpl-text-repricing_shipping" value="<?php echo esc_attr($wpl_repricing_shipping); ?>" placeholder="0.00" class="text_input" />
							<p class="desc" style="display: block;">
					...
					<div class="postbox" id="ImportSettingsBox">
						...
						<div class="inside">
                            ...
                            <?php ## BEGIN PRO ## ?>
                            <label for="wpl-enable_import_proxy" class="text_label">
                                <?php echo __( 'Enable import proxy', 'wp-lister-for-amazon' ) ?>
                                <?php wpla_tooltip('Enable this if you are getting HTTP 503 errors while importing listings from Amazon.') ?>
                            </label>
                            <select id="wpl-enable_import_proxy" name="wpla_enable_import_proxy" class=" required-entry select">
                                <option value="0" <?php if ( $wpl_enable_import_proxy == '0' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'No', 'wp-lister-for-amazon' ); ?> (<?php _e('default', 'wp-lister-for-amazon' ); ?>)</option>
                                <option value="1" <?php if ( $wpl_enable_import_proxy == '1' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Yes', 'wp-lister-for-amazon' ); ?></option>
                            </select>
                            <label for="wpl-import_proxy_url" class="text_label proxy-url-field">
                                <?php echo __( 'Import proxy URL', 'wp-lister-for-amazon' ) ?>
                                <?php wpla_tooltip('Add here the Proxy URL that WP-Lister will use when importing listings') ?>
                            </label>
                            <input type="text" name="wpla_import_proxy_url" id="wpl-text-import_proxy_url" value="<?php echo $wpl_import_proxy_url; ?>" placeholder="e.g. https://user:password@proxy.com" class="text_input proxy-url-field" />
                            <?php ## END PRO ## ?>
                    ...
                    <div class="postbox" id="InventorySyncSettingsBox">
                        <h3 class="hndle"><span><?php echo __( 'Inventory Check', 'wp-lister-for-amazon' ) ?></span></h3>
                        <div class="inside">

                            <label for="wpl-run_background_inventory_check" class="text_label">
                                <?php _e( 'Regular background inventory checks', 'wp-lister-for-amazon' ); ?>
                                <?php wpla_tooltip( 'Download an inventory report from Amazon regularly and compare inventory between Amazon and your WooCommerce store.'); ?>
                            </label>
                            <select id="wpl-run_background_inventory_check" name="wpla_run_background_inventory_check" class="required-entry select">
                                <option value="1" <?php selected( $wpl_run_background_inventory_check, 1 ); ?>><?php _e( 'Yes', 'wp-lister-for-amazon' ) ; ?> (<?php _e('default', 'wp-lister-for-amazon' ); ?>)</option>
                                <option value="0" <?php selected( $wpl_run_background_inventory_check, 0 ); ?>><?php _e( 'No', 'wp-lister-for-amazon' ); ?></option>
                            </select>

                            <label for="wpl-inventory_check_frequency" class="text_label show-if-inventory-check">
                                <?php _e( 'Inventory check frequency', 'wp-lister-for-amazon' ); ?>
                                <?php wpla_tooltip( '' ); ?>
                            </label>
                            <select id="wpl-inventory_check_frequency" name="wpla_inventory_check_frequency" class="required-entry select show-if-inventory-check">
                                <option value="1" <?php selected( $wpl_inventory_check_frequency, 1 ); ?>><?php _e( 'Hourly', 'wp-lister-for-amazon' ); ?></option>
                                <option value="3" <?php selected( $wpl_inventory_check_frequency, 3 ); ?>><?php _e( 'Every 3 hours', 'wp-lister-for-amazon' ); ?></option>
                                <option value="6" <?php selected( $wpl_inventory_check_frequency, 6 ); ?>><?php _e( 'Every 6 hours', 'wp-lister-for-amazon' ); ?></option>
                                <option value="12" <?php selected( $wpl_inventory_check_frequency, 12 ); ?>><?php _e( 'Every 12 hours', 'wp-lister-for-amazon' ); ?></option>
                                <option value="24" <?php selected( $wpl_inventory_check_frequency, 24 ); ?>><?php _e( 'Every 24 hours', 'wp-lister-for-amazon' ); ?></option>
                            </select>
                            <p class="desc show-if-inventory-check" style="display: block;">
                                <?php
                                echo __( 'Set how often to download inventory reports to compare against your local inventory.', 'wp-lister-for-amazon' );
                                ?><br/>
                            </p>

                            <label for="wpl-inventory_check_notification_email" class="text_label show-if-inventory-check">
                                <?php _e( 'Send inventory reports to', 'wp-lister-for-amazon' ); ?>
                                <?php wpla_tooltip( sprintf( 'Defaults to your admin email address (%s)', get_bloginfo( 'admin_email' ) ) ); ?>
                            </label>
                            <input type="email" name="wpla_inventory_check_notification_email" value="<?php esc_attr_e( $wpl_inventory_check_notification_email ); ?>" placeholder="<?php esc_attr_e( get_bloginfo( 'admin_email' ) ); ?>" class="text_input show-if-inventory-check" />
                            <p class="desc show-if-inventory-check" style="display: block;">
                                <?php echo __( 'Set the email address where inventory reports will be sent when inventory inconsistencies are found.', 'wp-lister-for-amazon' ); ?><br>
                            </p>
					...
					<div class="postbox" id="OtherSettingsBox">
						...
						<div class="inside">
							...
							<label for="wpl-enable_product_offer_images" class="text_label">
								<?php echo __( 'Enable Offer Images', 'wp-lister-for-amazon' ); ?>
							...
							<select id="wpl-enable_product_offer_images" name="wpla_enable_product_offer_images" class="required-entry select">
								<option value="0"  <?php if ( $wpl_enable_product_offer_images == '0' ):  ?>selected="selected"<?php endif; ?>><?php echo __( 'No', 'wp-lister-for-amazon' ); ?> (<?php _e('default', 'wp-lister-for-amazon' ); ?>)</option>
								<option value="1"  <?php if ( $wpl_enable_product_offer_images == '1' ):  ?>selected="selected"<?php endif; ?>><?php echo __( 'Yes', 'wp-lister-for-amazon' ); ?></option>
							</select>
							<p class="desc" style="display: block;">
								<?php echo __( 'Enable this to include offer images for used items in your ListingLoader feeds.', 'wp-lister-for-amazon' ); ?><br>
							</p>

							<label for="wpl-load_b2b_templates" class="text_label">
								<?php echo __( 'Enable B2B support', 'wp-lister-for-amazon' ); ?>
                                <?php wpla_tooltip('This option will enable dedicated B2B price fields on the edit product page, and load B2B feed templates.<br><br>If you want to use B2B templates, which include additional columns for bulk pricing, please enable this option first and then update your feed templates on the category settings page.') ?>
							</label>
							<select id="wpl-load_b2b_templates" name="wpla_load_b2b_templates" class="required-entry select">
								<option value="0"  <?php if ( $wpl_load_b2b_templates == '0' ):  ?>selected="selected"<?php endif; ?>><?php echo __( 'No', 'wp-lister-for-amazon' ); ?> (<?php _e('default', 'wp-lister-for-amazon' ); ?>)</option>
								<option value="1"  <?php if ( $wpl_load_b2b_templates == '1' ):  ?>selected="selected"<?php endif; ?>><?php echo __( 'Yes', 'wp-lister-for-amazon' ); ?></option>
							</select>
							<p class="desc" style="display: block;">
								<?php echo __( 'Enable this to use B2B pricing and feed templates.', 'wp-lister-for-amazon' ); ?><br>
							</p>

                            <label for="wpl-upload_vat_invoice" class="text_label">
                                <?php echo __( 'Enable invoice uploads', 'wp-lister-for-amazon' ); ?>
                                <?php wpla_tooltip('Enable this option to generate _UPLOAD_VAT_INVOICE_ feeds for your Amazon orders.') ?>
                            </label>
                            <select id="wpl-upload_vat_invoice" name="wpla_upload_vat_invoice" class="required-entry select">
                                <option value="0"  <?php selected( $wpl_upload_vat_invoice, 0 ); ?>><?php echo __( 'No', 'wp-lister-for-amazon' ); ?> (<?php _e('default', 'wp-lister-for-amazon' ); ?>)</option>
                                <option value="1"  <?php selected( $wpl_upload_vat_invoice, 1 ); ?>><?php echo __( 'Yes', 'wp-lister-for-amazon' ); ?></option>
                            </select>
                            <p class="desc" style="display: block;">
                                <?php echo __( 'Supported plugins: ', 'wp-lister-for-amazon' ); ?> WooCommerce Germanized, German Market, and WooCommerce PDF Invoices & Packing Slips
                            </p>

                            <label for="wpl-use_local_product_name_in_orders" class="text_label">
                                <?php echo __( 'Use local product name/title in orders', 'wp-lister-for-amazon' ); ?>
                                <?php wpla_tooltip('Enable this option load and use local WooCommerce product names when creating orders from Amazon.') ?>
                            </label>
                            <select id="wpl-use_local_product_name_in_orders" name="wpla_use_local_product_name_in_orders" class="required-entry select">
                                <option value="0"  <?php selected( $wpl_use_local_product_name_in_orders, 0 ); ?>><?php echo __( 'No', 'wp-lister-for-amazon' ); ?> (<?php _e('default', 'wp-lister-for-amazon' ); ?>)</option>
                                <option value="1"  <?php selected( $wpl_use_local_product_name_in_orders, 1 ); ?>><?php echo __( 'Yes', 'wp-lister-for-amazon' ); ?></option>
                            </select>
					        <!-- ## END PRO ## -->
                            ...
                            <input type="text" name="wpla_allowed_html_tags" id="wpl-text-allowed_html_tags" value="<?php echo esc_attr($wpl_allowed_html_tags); ?>" class="text_input" />
                            <p class="desc" style="display: block;">
                        ...
                        <div class="inside">
                            ...
                            <table id="ship-from-addresses-table">
                                ...
                                <?php foreach ( $wpl_ship_from_addresses as $i => $address ): ?>
                                    <tr>
                                        <td>
                                            <input type="text" name="ship_from_addresses[name][<?php echo $i; ?>]" value="<?php echo esc_attr($address['name']) ?>" class="text_input address-name" />
                                        </td>
                                        <td>
                                            <input type="text" name="ship_from_addresses[line_1][<?php echo $i; ?>]" value="<?php echo esc_attr($address['line_1']) ?>" class="text_input" />
                                        </td>
                                        <td>
                                            <input type="text" name="ship_from_addresses[line_2][<?php echo $i; ?>]" value="<?php echo esc_attr($address['line_2']) ?>" class="text_input" />
                                        </td>
                                        <td>
                                            <input type="text" name="ship_from_addresses[city][<?php echo $i; ?>]" value="<?php echo esc_attr($address['city']) ?>" class="text_input" />
                                        </td>
                                        <td>
                                            <input type="text" name="ship_from_addresses[state][<?php echo $i; ?>]" value="<?php echo esc_attr($address['state']) ?>" class="text_input" />
                                        </td>
                                        <td>
                                            <input type="text" name="ship_from_addresses[postal][<?php echo $i; ?>]" value="<?php echo esc_attr($address['postal']) ?>" class="text_input" />
                                        </td>
                                        <td>
                                            <input type="text" name="ship_from_addresses[country][<?php echo $i; ?>]" value="<?php echo esc_attr($address['country']) ?>" class="text_input" />
                                        </td>
					...
					<div class="postbox adv_options" id="ColorMapBox">
						...
						<div class="inside">
							...
							<table id="color-map-table">
								...
								<tr>
									<td>
										<input type="text" name="colormap_woocom[]" value="<?php echo esc_attr(@$wpl_colormap_woocom[$i]); ?>" class="text_input" />
									</td>
									<td>
						...
						<div class="inside">
							...
							<table id="variation-merger-table">
								...
								<tr>
									...
									<td style="width:3em;">
										<input type="text" name="varmerge_glue[]" value="<?php echo esc_attr(@$wpl_varmerge_glue[$i]); ?>" class="text_input" />
									</td>
									<td>
					...
					<div class="postbox adv_options" id="CustomShortcodesBox">
						...
						<div class="inside">
							...
							<table id="custom-shortcodes-table">
								...
								<tr>
									<td>
										<input type="text" name="shortcode_title[]" value="<?php echo esc_attr($shortcode['title']); ?>" class="text_input" placeholder="My shortcode" />
										<br>
										<input type="text" name="shortcode_slug[]" value="<?php echo esc_attr($shortcode['slug']); ?>" class="text_input" placeholder="my-shortcode"/>
									</td>
									<td>
					...
					<div class="postbox adv_options" id="CustomVariationMetaBox">
						...
						<div class="inside">
							...
							<table id="custom-variation-fields-table">
								...
								<tr>
									<td>
										<input type="text" name="varmeta_label[]" value="<?php echo esc_attr($varmeta['label']); ?>" class="text_input" placeholder="My custom field" />
									</td>
									<td>
										<input type="text" name="varmeta_key[]" value="<?php echo esc_attr($varmeta['key']); ?>" class="text_input" placeholder="my-custom-field"/>
									</td>
								</tr>
								<?php endforeach; ?>
