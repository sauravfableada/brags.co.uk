			...
			<div class="meta-box-sortables ui-sortable">
				...
				<div class="postbox" id="DatabaseToolBox">
					...
					<div class="inside">
						...
						<form method="post" action="<?php echo $wpl_form_action; ?>" onsubmit="return confirm('<?php echo esc_js( __( 'IMPORTANT: Have you backed up your database?\n\nThis will delete and recreate the product types table. Any custom product types will need to be re-added from Amazon.\n\nAre you sure you want to continue?', 'wp-lister-for-amazon' ) ); ?>');">
								<?php wp_nonce_field( 'wpla_tools_page' ); ?>
								<input type="hidden" name="action" value="wpla_reinstall_product_types_table" />
								<input type="submit" value="<?php echo __( 'Reinstall Product Types Table', 'wp-lister-for-amazon' ); ?>" name="submit" class="button button-primary">
								<p>
									<?php echo __( 'Drop and recreate the amazon_product_types table with default entries.', 'wp-lister-for-amazon' ); ?>
									<strong><?php echo __( 'Warning: This will delete all existing product types.', 'wp-lister-for-amazon' ); ?></strong>
								</p>
                                <p>
                                    <b><?php echo __( 'Important:', 'wp-lister-for-amazon' ); ?></b>
                                    <?php echo __( 'This is a beta feature still undergoing testing and improvements. We strongly recommend backing up your database before proceeding.', 'wp-lister-for-amazon' ); ?>
                                </p>
						</form>
						<!-- <br style="clear:both;"/> -->
