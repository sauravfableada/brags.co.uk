	    ...
	    border-right: none;
					...
					<div class="postbox" id="PricesBox">
						...
						<div class="inside">
							...
							<input type="text" name="wpla_price_add_percentage" id="wpl-text-price_add_percentage" value="<?php echo isset($wpl_profile_details['price_add_percentage']) ? esc_attr($wpl_profile_details['price_add_percentage']) : '' ?>" class="text_input" />
							<br class="clear" />
							...
							<input type="text" name="wpla_price_add_amount" id="wpl-text-price_add_amount" value="<?php echo isset($wpl_profile_details['price_add_amount']) ? esc_attr($wpl_profile_details['price_add_amount']) : '' ?>" class="text_input" />
							<!-- <br class="clear" /> -->
							...
							<?php if ( get_option('wpla_load_b2b_templates', 0) ): ?>
								...
								<h4><?php echo __( 'B2B Pricing', 'wp-lister-for-amazon' ); ?></h4>
								
								<label for="wpl-text-b2b_price" class="text_label">
									<?php echo __( 'Amazon B2B Price', 'wp-lister-for-amazon' ); ?>
									<?php wpla_tooltip('Set a default B2B price for products using this profile. This can be overridden at the product level. Supports shortcodes like [product_price] and percentage adjustments.') ?>
								</label>
								<input type="text" name="wpla_b2b_price" id="wpl-text-b2b_price" value="<?php echo isset($wpl_profile_details['b2b_price']) ? esc_attr($wpl_profile_details['b2b_price']) : '' ?>" class="text_input" placeholder="B2B Price or shortcode" />
								<br class="clear" />
							<?php endif; ?>
