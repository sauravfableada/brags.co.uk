				...
				<div class="meta-box-sortables ui-sortable">
					...
					<div class="postbox" id="FeedsOptionsBox" style="display:block;">
						...
						<div class="inside">
                            ...
                            <p class="desc" style="display: block;">
                                Enable this if you are experiencing missing orders when completing orders in bulk. (<a target="_blank" href="<?php echo wp_nonce_url( admin_url('admin.php?page=wpla-settings&tab=developer&action=wpla_view_feed_order_items'), 'wpla_view_feed_order_items' ); ?>">View Table</a>)
                            </p>

                            <label for="wpl-option-feed_background_processing" class="text_label"><?php echo __( 'Feed Background Processing', 'wp-lister-for-amazon' ); ?></label>
                            <select id="wpl-option-feed_background_processing" name="wpla_feed_background_processing" class=" required-entry select">
                                <option value="0" <?php selected( $wpl_feed_background_processing, '0' ); ?>>No (default)</option>
                                <option value="1" <?php selected( $wpl_feed_background_processing, '1' ); ?>>Yes</option>
                            </select>
                            <p class="desc" style="display: block;">
                                Enable background processing for feed generation to prevent memory issues on the Feeds page. When enabled, clicking Refresh will queue feed processing to run in the background via ActionScheduler.
                            </p>
					...
					<div class="postbox" id="StagingSiteSettingsBox">
						...
						<div class="inside">
							...
							<input type="text" name="wpla_staging_site_pattern" id="wpl-staging_site_pattern" value="<?php echo esc_attr($wpl_staging_site_pattern); ?>" class="text_input" />
							<p class="desc" style="display: block;">
					...
					<div class="postbox dev_box" id="DeveloperToolBox" style="">
						...
						<div class="inside">
					        ...
					        <!-- ## BEGIN PRO ## -->
							<label for="wpl-option-updater_mode" class="text_label"><?php echo __( 'Updater', 'wp-lister-for-amazon' ); ?></label>
							...
							<label for="wpl-wpla_instance" class="text_label"><?php echo __( 'Instance ID', 'wp-lister-for-amazon' ); ?></label>
							<input type="text" name="wpla_wpla_instance" id="wpl-wpla_instance" value="<?php echo esc_attr(get_option('wpla_instance')) ?>" class="text_input" />
							<p class="desc" style="display: block;">
