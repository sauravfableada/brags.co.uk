				...
				<?php if ( sizeof( $wpl_amazon_accounts ) == 0 ) : ?>
					...
					<div class="postbox" id="AuthSettingsBox">
						...
						<div class="inside">
							...
							<p>
								<?php _e( 'WP-Lister uses the Amazon Selling Partner API (SP-API) to communicate with your Amazon Seller Account.', 'wp-lister-for-amazon' ) ?>
								<?php _e( 'To connect your account, simply select your marketplace below and follow the authorization process.', 'wp-lister-for-amazon' ) ?>
							</p>
