...
class WPLA_Product_Feed_MetaBox {
	...
	function save_meta_box( $post_id, $post ) {
        ...
        if ( isset( $_POST['wpla_product_type'] ) ) {
            // update selected product type and marketplace
            ...
            if ( empty( $_POST['wpla_product_type'] ) || empty( $_POST['wpla_marketplace_id'] ) ) {
                // delete the custom feed columns if switching back to profile settings
                delete_post_meta( $post_id, '_wpla_custom_feed_columns' );
            } else {
                // update product type columns
