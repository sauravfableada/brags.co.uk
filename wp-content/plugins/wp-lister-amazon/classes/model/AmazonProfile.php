...
class WPLA_AmazonProfile {
	...
	function initDefaultFields() {
		...
		$this->fields = apply_filters( 'wpla_profile_attributes_default_values', array(
			// JSON feeds
			...
			'purchasable_offer[0][our_price][0][schedule][0][value_with_tax]'         => '[product_price]',
			'purchasable_offer[0][discounted_price][0][schedule][0][value_with_tax]'  => '[product_sale_price]',
			'purchasable_offer[0][discounted_price][0][schedule][0][start_at]'        => '[product_sale_start]',
			'purchasable_offer[0][discounted_price][0][schedule][0][end_at]'          => '[product_sale_end]',
