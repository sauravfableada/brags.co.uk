...
if (!\function_exists('EasyWPSMTP\\Vendor\\mb_str_pad')) {
    /** @return string|false */
...
if (!\function_exists('EasyWPSMTP\\Vendor\\mb_ucfirst')) {
    /** @return string|false */
...
if (!\function_exists('EasyWPSMTP\\Vendor\\mb_lcfirst')) {
    /** @return string|false */
...
if (!\function_exists('EasyWPSMTP\\Vendor\\mb_trim')) {
    /** @return string|false */
...
if (!\function_exists('EasyWPSMTP\\Vendor\\mb_ltrim')) {
    /** @return string|false */
...
if (!\function_exists('EasyWPSMTP\\Vendor\\mb_rtrim')) {
    /** @return string|false */
