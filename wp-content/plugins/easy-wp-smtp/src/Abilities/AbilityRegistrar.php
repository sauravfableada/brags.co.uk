...
/**
 * Registers Easy WP SMTP abilities with the WordPress Abilities API.
 *
...
class AbilityRegistrar {
	 ...
	 * @var string
	 */
	const ABILITY_NAMESPACE = 'easy-wp-smtp';

	/**
	 * Category slug shared by all Easy WP SMTP abilities.
	 *
	 * @since 2.15.0
	 *
	 * @var string
	 */
	const CATEGORY_SLUG = 'easy-wp-smtp';
	...
	/**
	 * Register the Easy WP SMTP ability category.
	 *
	 * @since 2.15.0
	 */
	public function register_category() {
		...
		call_user_func(
			...
			self::CATEGORY_SLUG,
			[
				'label'       => esc_html__( 'Easy WP SMTP', 'easy-wp-smtp' ),
				'description' => esc_html__( 'Read-only access to Easy WP SMTP email logs, statistics, and debug events.', 'easy-wp-smtp' ),
			]
		);
	}
