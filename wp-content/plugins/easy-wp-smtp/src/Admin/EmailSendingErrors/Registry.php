...
class Registry {
	...
	/**
	 * Fallback product-api base URL when EASY_WP_SMTP_PRODUCT_API_BASE_URL is undefined.
	 *
	 * @since 2.15.0
	 */
	const BASE_URL = 'https://easywpsmtpapi.com';
	 ...
	 * @since 2.15.0
	 */
	const TRANSIENT_KEY = 'easy_wp_smtp_email_sending_errors_registry';
	 ...
	 * @since 2.15.0
	 */
	const FETCH_BACKOFF_TRANSIENT_PREFIX = 'easy_wp_smtp_email_sending_errors_registry_fetch_backoff_';
	...
	private function fetch( $mailer ) {
		...
		$base_url = defined( 'EASY_WP_SMTP_PRODUCT_API_BASE_URL' ) ? EASY_WP_SMTP_PRODUCT_API_BASE_URL : self::BASE_URL;
