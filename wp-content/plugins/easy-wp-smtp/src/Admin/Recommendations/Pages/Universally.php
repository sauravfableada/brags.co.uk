...
class Universally extends PageAbstract {
	 ...
	 * @var string
	 */
	public const SLUG = 'easy-wp-smtp-recommended-universally';
	...
	protected $config = [
		...
		'pro_plugin'             => '',
		'universally_addon'      => '',
		'universally_addon_page' => 'https://universally.com/?utm_source=easywpsmtpplugin&utm_medium=link&utm_campaign=translation-page',
	...
	protected function get_heading_title(): string {
		...
		return esc_html__( 'Translate Your Website and Go Global in Minutes', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_heading_alt_text(): string {
		...
		return esc_attr__( 'Easy WP SMTP ♥ Universally', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_heading_strings(): array {
		...
		return [ // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
			esc_html__( 'Universally uses AI to translate your entire WordPress site into 110+ languages in minutes, understanding context and keeping your brand voice intact. No coding required.', 'easy-wp-smtp' ),
			esc_html__( 'Built for global reach. Designed for everyone.', 'easy-wp-smtp' ),
		];
	}
	...
	protected function get_screenshot_features(): array {
		...
		return [ // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
			esc_html__( 'AI translation into 110+ languages.', 'easy-wp-smtp' ),
			esc_html__( 'Multilingual SEO with translated URLs and meta.', 'easy-wp-smtp' ),
			esc_html__( 'Auto-translates new content when you publish.', 'easy-wp-smtp' ),
			esc_html__( 'Exclude specific pages, classes, or IDs from translation.', 'easy-wp-smtp' ),
		];
	}
	...
	protected function get_screenshot_alt_text(): string {
		...
		return esc_attr__( 'Universally screenshot', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function output_section_step_result(): void {
		...
		printf(
			...
			esc_html__( 'Reach Even More of the World', 'easy-wp-smtp' ),
			esc_html__( 'Upgrade your plan for more languages and higher translation limits.', 'easy-wp-smtp' ),
	...
	protected function get_install_heading(): string {
		...
		return esc_html__( 'Install & Activate Universally', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_install_description(): string {
		...
		return esc_html__( 'Install Universally from the WordPress.org plugin repository.', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_plugin_title(): string {
		...
		return esc_html__( 'Universally', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_install_button_text(): string {
		...
		return esc_html__( 'Install Universally', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_installed_activated_text(): string {
		...
		return esc_html__( 'Universally Installed & Activated', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_activate_text(): string {
		...
		return esc_html__( 'Activate Universally', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_setup_heading(): string {
		...
		return esc_html__( 'Connect Universally', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_setup_description(): string {
		...
		return esc_html__( 'Add your API key on the settings page and choose the languages for your site.', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
