...
class ActiveLayer extends PageAbstract {
	 ...
	 * @var string
	 */
	public const SLUG = 'easy-wp-smtp-recommended-activelayer';
	...
	protected $config = [
		...
		'pro_plugin'             => '',
		'activelayer_addon'      => '',
		'activelayer_addon_page' => 'https://activelayer.com/pricing/?utm_source=easywpsmtpplugin&utm_medium=link&utm_campaign=spam-protection-page',
	...
	protected function get_heading_title(): string {
		...
		return esc_html__( 'Block Spam Without Blocking Real Visitors', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_heading_alt_text(): string {
		...
		return esc_attr__( 'Easy WP SMTP ♥ ActiveLayer', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_heading_strings(): array {
		...
		return [ // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
			esc_html__( 'ActiveLayer uses server-side AI to catch spam in milliseconds, invisible to your real visitors and deadly to bots. No CAPTCHAs, no friction, no lost conversions.', 'easy-wp-smtp' ),
			esc_html__( 'Smarter protection for your forms, comments, and reviews.', 'easy-wp-smtp' ),
		];
	}
	...
	protected function get_screenshot_features(): array {
		...
		return [ // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
			esc_html__( 'AI detection using content, sender reputation, and behavior signals.', 'easy-wp-smtp' ),
			esc_html__( 'No CAPTCHAs, no friction for real visitors.', 'easy-wp-smtp' ),
			esc_html__( 'Millisecond verdicts, invisible to legitimate users.', 'easy-wp-smtp' ),
			esc_html__( 'Works with 9+ popular form plugins out of the box.', 'easy-wp-smtp' ),
		];
	}
	...
	protected function get_screenshot_alt_text(): string {
		...
		return esc_attr__( 'ActiveLayer screenshot', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function output_section_step_result(): void {
		...
		printf(
			...
			esc_html__( 'Protect Even More of Your Site', 'easy-wp-smtp' ),
			esc_html__( 'Upgrade your plan for higher limits and advanced controls across all your forms, comments, and reviews.', 'easy-wp-smtp' ),
	...
	protected function get_install_heading(): string {
		...
		return esc_html__( 'Install & Activate ActiveLayer', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_install_description(): string {
		...
		return esc_html__( 'Install ActiveLayer from the WordPress.org plugin repository.', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_plugin_title(): string {
		...
		return esc_html__( 'ActiveLayer', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_install_button_text(): string {
		...
		return esc_html__( 'Install ActiveLayer', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_installed_activated_text(): string {
		...
		return esc_html__( 'ActiveLayer Installed & Activated', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_activate_text(): string {
		...
		return esc_html__( 'Activate ActiveLayer', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_setup_heading(): string {
		...
		return esc_html__( 'Connect ActiveLayer', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_setup_description(): string {
		...
		return esc_html__( 'Add your free API key on the settings page to switch on protection.', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_setup_button_text(): string {
		...
		return esc_html__( 'Open Settings', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
