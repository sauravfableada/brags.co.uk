...
class WPConsent extends PageAbstract {
	 ...
	 * @var string
	 */
	public const SLUG = 'easy-wp-smtp-recommended-wpconsent';
	...
	protected $config = [
		...
		'wpconsent_addon_page' => 'https://wpconsent.com/?utm_source=easywpsmtpplugin&utm_medium=link&utm_campaign=privacy-compliance-page',
	...
	protected function get_heading_title(): string {
		...
		return esc_html__( 'Make Your Website Privacy-Compliant in Minutes', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_heading_alt_text(): string {
		...
		return esc_attr__( 'Easy WP SMTP ♥ WPConsent', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_heading_strings(): array {
		...
		return [ // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
			esc_html__( 'Build trust with clear, compliant privacy practices. WPConsent adds clean, professional banners and handles the technical side for you.', 'easy-wp-smtp' ),
			esc_html__( 'Built for transparency. Designed for ease.', 'easy-wp-smtp' ),
		];
	}
	...
	protected function get_screenshot_features(): array {
		...
		return [ // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
			esc_html__( 'A professional banner that fits your site.', 'easy-wp-smtp' ),
			esc_html__( 'Tools like Google Analytics and Facebook Pixel paused until consent.', 'easy-wp-smtp' ),
			esc_html__( 'Peace of mind knowing you’re aligned with global laws.', 'easy-wp-smtp' ),
			esc_html__( 'Self-hosted. Your data remains on your site.', 'easy-wp-smtp' ),
		];
	}
	...
	protected function get_screenshot_alt_text(): string {
		...
		return esc_attr__( 'WPConsent screenshot', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function output_section_step_result(): void {
		...
		printf(
			...
			esc_html__( 'Get Advanced Cookie Consent Features', 'easy-wp-smtp' ),
			esc_html__( 'With WPConsent Pro you can access advanced features like geolocation, popup layout, records of consent, multilanguage support, and more.', 'easy-wp-smtp' ),
	...
	protected function get_data_step_result(): array { // phpcs:ignore Generic.Metrics.CyclomaticComplexity.TooHigh
		...
		$step['button_text']   = esc_html__( 'Learn More', 'easy-wp-smtp' );
		...
		switch ( $plugin_license_level ) {
			...
			case 'pro':
				...
				$step['button_text']  =
					$addon_installed
						? esc_html__( 'WPConsent Pro Installed & Activated', 'easy-wp-smtp' )
						: esc_html__( 'Install Now', 'easy-wp-smtp' );
	...
	protected function get_install_heading(): string {
		...
		return esc_html__( 'Install & Activate WPConsent', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_install_description(): string {
		...
		return esc_html__( 'Install WPConsent from the WordPress.org plugin repository.', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_plugin_title(): string {
		...
		return esc_html__( 'WPConsent', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_install_button_text(): string {
		...
		return esc_html__( 'Install WPConsent', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_installed_activated_text(): string {
		...
		return esc_html__( 'WPConsent Installed & Activated', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_activate_text(): string {
		...
		return esc_html__( 'Activate WPConsent', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_setup_heading(): string {
		...
		return esc_html__( 'Set Up WPConsent', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_setup_description(): string {
		...
		return esc_html__( 'WPConsent has an intuitive setup wizard to guide you through the cookie consent configuration process.', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_setup_button_text(): string {
		...
		return esc_html__( 'Run Setup Wizard', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_pro_installed_activated_text(): string {
		...
		return esc_html__( 'WPConsent Pro Installed & Activated', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
}
