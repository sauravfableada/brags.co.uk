...
class WPCode extends PageAbstract {
	 ...
	 * @var string
	 */
	public const SLUG = 'easy-wp-smtp-recommended-wpcode';
	...
	protected $config = [
		...
		'wpcode_addon_page' => 'https://wpcode.com/lite/?utm_source=easywpsmtpplugin&utm_medium=link&utm_campaign=code-snippets-page',
	...
	protected function get_heading_title(): string {
		...
		return esc_html__( 'Add Custom Code to WordPress Without Breaking Your Site', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_heading_alt_text(): string {
		...
		return esc_attr__( 'Easy WP SMTP ♥ WPCode', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_heading_strings(): array {
		...
		return [ // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
			esc_html__( 'WPCode lets you safely add PHP, JavaScript, CSS, and HTML snippets with no theme edits and no risk of losing changes when your theme updates. Built-in error handling keeps your site from breaking.', 'easy-wp-smtp' ),
			esc_html__( 'Trusted by over 3 million websites.', 'easy-wp-smtp' ),
		];
	}
	...
	protected function get_screenshot_features(): array {
		...
		return [ // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
			esc_html__( 'Add snippets without editing theme files.', 'easy-wp-smtp' ),
			esc_html__( 'PHP, JavaScript, CSS, and HTML all supported.', 'easy-wp-smtp' ),
			esc_html__( '100+ ready-made snippets for common tasks.', 'easy-wp-smtp' ),
			esc_html__( 'Auto-insert and one-click toggle for every snippet.', 'easy-wp-smtp' ),
		];
	}
	...
	protected function get_screenshot_alt_text(): string {
		...
		return esc_attr__( 'WPCode screenshot', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function output_section_step_result(): void {
		...
		printf(
			...
			esc_html__( 'Get Advanced Code Snippet Features', 'easy-wp-smtp' ),
			esc_html__( 'WPCode Pro adds conditional logic, a cloud snippet library, revisions, and conversion pixels to your workflow.', 'easy-wp-smtp' ),
	...
	protected function get_data_step_result(): array {
		...
		if ( ! $this->is_pro_active() ) {
			...
			$step['button_text']  = $addon_installed
				? esc_html__( 'WPCode Pro Installed & Activated', 'easy-wp-smtp' )
	...
	protected function get_install_heading(): string {
		...
		return esc_html__( 'Install & Activate WPCode', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_install_description(): string {
		...
		return esc_html__( 'Install WPCode from the WordPress.org plugin repository.', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_plugin_title(): string {
		...
		return esc_html__( 'WPCode', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_install_button_text(): string {
		...
		return esc_html__( 'Install WPCode', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_installed_activated_text(): string {
		...
		return esc_html__( 'WPCode Installed & Activated', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_activate_text(): string {
		...
		return esc_html__( 'Activate WPCode', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_setup_heading(): string {
		...
		return esc_html__( 'Set Up WPCode', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_setup_description(): string {
		...
		return esc_html__( 'Open WPCode to create your first snippet and start customizing your site safely.', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_setup_button_text(): string {
		...
		return esc_html__( 'Open WPCode', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
	...
	protected function get_pro_installed_activated_text(): string {
		...
		return esc_html__( 'WPCode Pro Installed & Activated', 'easy-wp-smtp' ); // phpcs:ignore WPForms.Formatting.EmptyLineBeforeReturn.RemoveEmptyLineBeforeReturnStatement
	}
}
