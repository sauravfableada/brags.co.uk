...
use EasyWPSMTP\Migrations\MigrationAbstract;
...
class Migration extends MigrationAbstract {
	 ...
	 * @since 2.15.0
	 */
	const OPTION_NAME = 'easy_wp_smtp_recommendations_migration_version';
	 ...
	 * @since 2.15.0
	 */
	const ERROR_OPTION_NAME = 'easy_wp_smtp_recommendations_migration_error';
