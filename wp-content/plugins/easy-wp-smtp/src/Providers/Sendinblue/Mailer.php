...
class Mailer extends MailerAbstract {
	 ...
	 *
	 * @since 2.0.0
	 * @since 2.2.0 Update to use Brevo API.
	 *
	 * @var string
	 */
	 ...
	 *
	 * @since 2.0.0
	 * @since 2.2.0 Returns JSON encoded email body instead of `SendSmtpEmail` object.
	 *
	 * @return string
	 */
	public function get_body() {
		 ...
		 */
		$body = apply_filters( 'easy_wp_smtp_providers_sendinblue_mailer_get_body', $this->body );
	 ...
	 *
	 * @since 2.0.0
	 * @since 2.2.0 Expect a generic class object instead of `CreateSmtpEmail`.
	 *
	 ...
	 *
	 * @since 2.0.0
	 * @since 2.2.0 Check if `$this->response` has `messageId` property to check if the email was sent.
	 *
	 * @return bool
	 */
	public function is_email_sent() {
		...
		return apply_filters( 'easy_wp_smtp_providers_mailer_is_email_sent', $this->has_message_id(), $this->mailer ); // phpcs:ignore WPForms.PHP.ValidateHooks.InvalidHookName
	}
