...
abstract class MailerAbstract implements MailerInterface {
	...
	public function process_phpmailer( $phpmailer ) {
		...
		if ( ! easy_wp_smtp()->is_valid_phpmailer( $phpmailer ) ) {
			return;
		}
	...
	public function get_body() {
		...
		return apply_filters( 'easy_wp_smtp_providers_mailer_get_body', $this->body, $this->mailer );
	}
	...
	public function get_headers() {
		...
		return apply_filters( 'easy_wp_smtp_providers_mailer_get_headers', $this->headers, $this->mailer );
	}
	...
	public function is_email_sent() {
		 ...
		 */
		return apply_filters( 'easy_wp_smtp_providers_mailer_is_email_sent', $is_sent, $this->mailer );
	}
	...
	public function is_php_compatible() {
		...
		$options = easy_wp_smtp()->get_providers()->get_options( $this->mailer, $this->connection );
	...
	public function verify_sent_status( $email_log_id ) {
		...
		do_action( 'easy_wp_smtp_providers_mailer_verify_sent_status', $email_log_id, $this );
	}
	...
	public function remote_request( $url, $params ) {
		 ...
		 * @param MailerAbstract $mailer Mailer object.
		 */
		$params = apply_filters( 'easy_wp_smtp_providers_mailer_remote_request_params', $params, $this );
		 ...
		 * @param MailerAbstract $mailer Mailer object.
		 */
		$url = apply_filters( 'easy_wp_smtp_providers_mailer_remote_request_url', $url, $this );
