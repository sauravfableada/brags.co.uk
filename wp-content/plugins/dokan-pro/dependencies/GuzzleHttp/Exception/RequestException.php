...
use WeDevs\DokanPro\Dependencies\GuzzleHttp\BodySummarizer;
use WeDevs\DokanPro\Dependencies\GuzzleHttp\BodySummarizerInterface;
use WeDevs\DokanPro\Dependencies\Psr\Http\Client\RequestExceptionInterface;
...
class RequestException extends TransferException implements RequestExceptionInterface
{
    ...
    public static function create(
        ...
        $uri = \WeDevs\DokanPro\Dependencies\GuzzleHttp\Psr7\Utils::redactUserInfo($request->getUri());
