...
use WeDevs\DokanPro\Dependencies\GuzzleHttp\Psr7\Exception\MalformedUriException;
...
class Uri implements UriInterface, \JsonSerializable
{
     ...
     * `WeDevs\DokanPro\Dependencies\Psr\Http\Message\UriInterface::__toString`.
     *
     ...
     *
     * `WeDevs\DokanPro\Dependencies\Psr\Http\Message\UriInterface::getPort` may return null or the standard port. This method can be used
