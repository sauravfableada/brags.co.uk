...
use WeDevs\DokanPro\Dependencies\GuzzleHttp\Handler\CurlHandler;
use WeDevs\DokanPro\Dependencies\GuzzleHttp\Handler\CurlMultiHandler;
use WeDevs\DokanPro\Dependencies\GuzzleHttp\Handler\CurlShareHandleState;
use WeDevs\DokanPro\Dependencies\GuzzleHttp\Handler\CurlVersion;
use WeDevs\DokanPro\Dependencies\GuzzleHttp\Handler\Proxy;
use WeDevs\DokanPro\Dependencies\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function chooseHandler(array $handlerOptions = []): callable
    {
        ...
        throw new \RuntimeException('WeDevs\DokanPro\Dependencies\GuzzleHttp requires cURL, the allow_url_fopen ini setting, or a custom HTTP handler.');
    }
