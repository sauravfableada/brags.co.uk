...
final class RequestOptions
{
    ...
    /**
     * body: (resource|string|null|int|float|bool|\WeDevs\DokanPro\Dependencies\Psr\Http\Message\StreamInterface|(callable&object)|\Iterator|\WeDevs_DokanPro_WeDevs_DokanPro_Stringable)
    ...
    /**
     * cookies: (false|WeDevs\DokanPro\Dependencies\GuzzleHttp\Cookie\CookieJarInterface, default=false)
    ...
    /**
     * sink: (resource|string|\WeDevs\DokanPro\Dependencies\Psr\Http\Message\StreamInterface) Where the data
