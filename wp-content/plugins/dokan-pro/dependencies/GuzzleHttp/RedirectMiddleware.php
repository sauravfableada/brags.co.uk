...
use WeDevs\DokanPro\Dependencies\GuzzleHttp\Exception\BadResponseException;
use WeDevs\DokanPro\Dependencies\GuzzleHttp\Exception\TooManyRedirectsException;
