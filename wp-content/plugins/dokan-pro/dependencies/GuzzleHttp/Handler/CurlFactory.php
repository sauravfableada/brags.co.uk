...
namespace WeDevs\DokanPro\Dependencies\GuzzleHttp\Handler;

use WeDevs\DokanPro\Dependencies\GuzzleHttp\Exception\ConnectException;
...
use WeDevs\DokanPro\Dependencies\GuzzleHttp\Promise\FulfilledPromise;
use WeDevs\DokanPro\Dependencies\GuzzleHttp\Promise\PromiseInterface;
use WeDevs\DokanPro\Dependencies\GuzzleHttp\Psr7;
use WeDevs\DokanPro\Dependencies\GuzzleHttp\Psr7\LazyOpenStream;
use WeDevs\DokanPro\Dependencies\GuzzleHttp\Psr7\Uri;
use WeDevs\DokanPro\Dependencies\GuzzleHttp\TransferStats;
use WeDevs\DokanPro\Dependencies\GuzzleHttp\TransportSharing;
use WeDevs\DokanPro\Dependencies\GuzzleHttp\Utils;
