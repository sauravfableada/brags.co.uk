...
$changelog = [
    [
        ...
        'changes'  => [
            'Fix' => [
                [
                    'title'       => 'Prevented stored XSS in the Live Chat (Tawk.to) module by escaping vendor Property and Widget IDs in the storefront chat script.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improved seller-wise shipping package splitting when the WooCommerce cart is not yet ready.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improved Commission API category handling so the product editor\'s earning preview stays accurate.',
                    'description' => '',
                ],
                [
                    'title'       => 'Ensured vendor\'s own draft and hidden products remain visible in the new dashboard product list when the Request for Quotation module is active.',
                    'description' => '',
                ],
                [
                    'title'       => 'Refined the admin Product Q&A table column widths for a clearer, more consistent layout.',
                    'description' => '',
                ],
            ],
        ],
    ...
    [
        ...
        'changes'  => [
            'New Feature' => [
                [
                    'title'       => 'Added store pickup support to Delivery Time on block checkout, excluding shipping charges for pickup vendors with live order total updates.',
                    'description' => '',
                ],
            ],
            'Improvement' => [
                [
                    'title'       => 'Migrated admin dashboard list tables to the unified DataViews experience for consistent tabs, filters, search, and actions.',
                    'description' => '',
                ],
                [
                    'title'       => 'Added a "Search by Author" filter to the vendor dashboard reviews page.',
                    'description' => '',
                ],
            ],
            'Fix' => [
                [
                    'title'       => 'Patched SQL injection via the latitude and longitude parameters in the geolocation query.',
                    'description' => '',
                ],
                [
                    'title'       => 'Patched SQL injection via the orderby parameter in the Request for Quotation list query.',
                    'description' => '',
                ],
                [
                    'title'       => 'Fixed a vendor-staff privilege escalation in the update_capabilities REST endpoint.',
                    'description' => '',
                ],
                [
                    'title'       => 'Prevented Stripe Express transfers from exceeding the charge amount when admin coupons are applied.',
                    'description' => '',
                ],
                [
                    'title'       => 'Enforced the subscription product limit during bulk edit on the vendor dashboard.',
                    'description' => '',
                ],
                [
                    'title'       => 'Loaded AI image enhancer assets on the new vendor dashboard layout product and auction pages.',
                    'description' => '',
                ],
                [
                    'title'       => 'Corrected the free shipping "Only X away" notice to show only when free shipping is actually available on classic checkout.',
                    'description' => '',
                ],
                [
                    'title'       => 'Lazy-loaded product editor taxonomies to prevent memory exhaustion on stores with large catalogues.',
                    'description' => '',
                ],
            ],
        ],
    ...
    [
        ...
        'changes'  => [
            'Fix' => [
                [
                    'title'       => 'Fixed the empty Rank Math SEO panel in the new product editor when Rank Math bundles a newer CMB2 version.',
                    'description' => '',
                ],
                [
                    'title'       => 'Fixed untranslated subscription limit notices on the vendor dashboard product listing page.',
                    'description' => '',
                ],
            ],
        ],
    ...
    [
        ...
        'changes'  => [
            'New Feature' => [
                [
                    'title'       => 'Added Product Add-ons support to the new vendor product editor so vendors can manage add-ons without legacy editor.',
                    'description' => '',
                ],
                [
                    'title'       => 'Added a Rank Math SEO section to the new product editor with the full Rank Math metabox UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Added vendor-specific coupons analytics data on the vendor report analytics.',
                    'description' => '',
                ],
            ],
            'Fix' => [
                [
                    'title'       => 'Adjusted the RTL switcher translation for improved layout consistency.',
                    'description' => '',
                ],
            ],
        ],
    ...
    [
        ...
        'changes'  => [
            'Improvement' => [
                [
                    'title'       => 'Loaded AI image enhancer assets in the product editor only when AI image/text features are enabled.',
                    'description' => '',
                ],
            ],
            'Fix' => [
                [
                    'title'       => 'Resolved vendor inbox chat layout and height inconsistencies for a responsive, viewport-aware UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Fixed untranslated Quick Edit, Duplicate, and Advertise strings on the vendor dashboard products page.',
                    'description' => '',
                ],
            ],
        ],
    ...
    [
        ...
        'changes'  => [
            'New Feature' => [
                [
                    'title'       => 'Added Paystack support on the order-pay endpoint with transaction verification to reuse existing payments.',
                    'description' => '',
                ],
                [
                    'title'       => 'Added search and sortable Priority column to the Product Add-ons admin list.',
                    'description' => '',
                ],
            ],
            'Improvement' => [
                [
                    'title'       => 'Honored the "Enable Selling — Verified Only" setting during subscription purchase and staff account creation.',
                    'description' => '',
                ],
                [
                    'title'       => 'Hide customer-identifying details in vendor order views and emails based on admin settings.',
                    'description' => '',
                ],
            ],
            'Fix' => [
                [
                    'title'       => 'Surfaced proper validation errors on Stripe Express checkout and stopped processing on failure.',
                    'description' => '',
                ],
                [
                    'title'       => 'Prevented the Add Shipping Method dropdown from clipping inside the shipping modal.',
                    'description' => '',
                ],
                [
                    'title'       => 'Showed manual order address modal warnings as inline alerts instead of transient toasts.',
                    'description' => '',
                ],
                [
                    'title'       => 'Restored bullet point styling in vendor subscription pack details.',
                    'description' => '',
                ],
                [
                    'title'       => 'Corrected Payment Methods menu visibility on the customer dashboard.',
                    'description' => '',
                ],
                [
                    'title'       => 'Resolved malformed HTML and missing data in RMA and conversation notification emails.',
                    'description' => '',
                ],
                [
                    'title'       => 'Corrected the 404 documentation URL for the Product Form Manager module.',
                    'description' => '',
                ],
                [
                    'title'       => 'Resolved vendor verification upload failure on the seller setup wizard\'s Verifications step.',
                    'description' => '',
                ],
                [
                    'title'       => 'Pointed the What\'s New admin notice "View Details" CTA to the correct changelog page',
                    'description' => '',
                ],
            ],
        ],
    ...
    [
        ...
        'changes'  => [
            'New Module' => [
                [
                    'title'       => 'Product Form Customization module to control vendor product form fields and layout.',
                    'description' => '',
                ],
            ],
            'New Feature' => [
                [
                    'title'       => 'Re-engineered the ShipStation vendor dashboard with a React-based interface.',
                    'description' => '',
                ],
                [
                    'title'       => 'Implemented the Admin RFQ (Request for Quote) pages with the new admin frontend.',
                    'description' => '',
                ],
                [
                    'title'       => 'Implemented the Admin Reports page with the new React frontend.',
                    'description' => '',
                ],
                [
                    'title'       => 'Introduced a brand-new Admin Earnings panel under Admin Reports.',
                    'description' => '',
                ],
                [
                    'title'       => 'Added an iframe-based support ticket modal and integrated it with the Pro support button.',
                    'description' => '',
                ],
            ],
            'New' => [
                [
                    'title'       => 'Migrated the vendor dashboard Booking page list tables (3 tables) to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the Auction page list tables (3 tables, admin and vendor dashboard) to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the User Subscriptions page list table to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the Request Quotes (RFQ) page list table to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the Coupons page list tables (2 tables) to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the Reports - Statement page list table to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the Reviews page list table to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the Seller Badge page list table to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the Product Q&A page list table to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the Return Requests (RMA) page list table to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the Seller Staff page list table to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the Store Followers page list table to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the Vendor Subscription page list table to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the Store Stats page list table to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the Admin Support page list table to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the Support Tickets page list table to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the Settings - Product Add-ons page list table to React with Plugin UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Migrated the Settings - Shipping page list tables (2 tables) to React with Plugin UI.',
                    'description' => '',
                ],
            ],
            'Improvement' => [
                ...
                [
                    'title'       => 'Refreshed the Vendor Announcement panel UX, including the modal "View" URL.',
                    'description' => '',
                ],
                [
                    'title'       => 'Refactored the product editor namespace and assets for better maintainability.',
                    'description' => '',
                ],
                [
                    'title'       => 'Updated the request quote back-link URL and Add-ons table column width.',
                    'description' => '',
                ],
                [
                    'title'       => 'Updated the subscription URL on the page notice and the subscription duplicate action logic.',
                    'description' => '',
                ],
            ],
            'Fix' => [
                [
                    'title'       => 'Resolved the admin earnings filtering context mismatch.',
                    'description' => '',
                ],
                [
                    'title'       => 'Resolved the ShipStation vendor connection by adding vendor-scoped REST endpoints for diagnostics, inventory, and orders.',
                    'description' => '',
                ],
                [
                    'title'       => 'Resolved Product Q&A delete action and modal display issues.',
                    'description' => '',
                ],
                [
                    'title'       => 'Corrected the brand filter, Store Stats active menu, and Product Q&A table interactions.',
                    'description' => '',
                ],
                [
                    'title'       => 'Resolved Store Stats UI inconsistencies on the vendor dashboard.',
                    'description' => '',
                ],
                [
                    'title'       => 'Resolved the undefined array key \'include-hidden-product\' notice on the admin product list.',
                    'description' => '',
                ],
                [
                    'title'       => 'Added the missing title field on the Request Quotes form.',
                    'description' => '',
                ],
                [
                    'title'       => 'Resolved Stripe Express checkout shipping method update failure for Apple Pay.',
                    'description' => '',
                ],
            ],
        ],
    ...
    [
        ...
        'changes'  => [
            'Fix' => [
                [
                    'title'       => 'Resolve Stripe Express vendor payment disbursement not executing independently for completed suborders in multi-vendor orders.',
                    'description' => 'Previously, vendors in multi-vendor orders had to wait for the parent order to complete before receiving their Stripe payout. Now each suborder disburses independently upon completion via a dedicated mono-funnel lock pattern, preventing race conditions and ensuring reliable vendor payments.',
                ],
            ],
        ],
    ],
    [
        ...
        'changes'  => [
            'Improvement' => [
                [
                    'title'       => 'Provide vendor delivery time configuration and available slot data via Store API for cart and checkout.',
                    'description' => '',
                ],
                [
                    'title'       => 'Return order-specific delivery information instead of vendor configuration in the shop order REST API response.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improve mobile responsiveness for the manual order creation page in vendor dashboard.',
                    'description' => '',
                ],
                [
                    'title'       => 'Add REST support to allow vendors to update order delivery time information.',
                    'description' => '',
                ],
                [
                    'title'       => 'Apply quote page redirection link to quote restriction error notice for better navigation.',
                    'description' => '',
                ],
                [
                    'title'       => 'Introduce hooks and slots for vendor subscription pack list template customization.',
                    'description' => '',
                ],
                [
                    'title'       => 'Added control over vendor staff access to Delivery Time menus via dedicated permission capabilities in the Manage Permissions panel.',
                    'description' => '',
                ],
            ],
            'Fix' => [
                [
                    'title'       => 'Resolve admin subscription page calling incorrect API endpoint when vendor subscription is disabled from settings.',
                    'description' => '',
                ],
                [
                    'title'       => 'Stripe Express onboarding country not updating based on vendor store location changes.',
                    'description' => '',
                ],
                [
                    'title'       => 'Resolve untranslated strings on vendor dashboard Reports Stock screen.',
                    'description' => '',
                ],
                [
                    'title'       => 'Standardize unlimited values across Dokan Subscription product settings fields for pack validity.',
                    'description' => '',
                ],
                [
                    'title'       => 'Resolve translation not loading for vendor dashboard Store Support menu.',
                    'description' => '',
                ],
            ],
        ],
    ...
    [
        ...
        'changes'  => [
            'Improvement' => [
                [
                    'title'       => 'Prevent incorrect product count and subscription limit enforcement during CSV import.',
                    'description' => '',
                ],
                [
                    'title'       => 'Stripe Express payout delay for suborders to process vendor payments independently upon individual suborder completion.',
                    'description' => '',
                ],
                [
                    'title'       => 'Update Razorpay SDK to resolve dependency conflicts.',
                    'description' => '',
                ],
            ],
            'Fix' => [
                [
                    'title'       => 'Handle input sanitization and output escaping to prevent vulnerability.',
                    'description' => '',
                ],
                [
                    'title'       => 'Handle product dropdown in the Advertisement modal to correctly fetch vendor-specific products.',
                    'description' => '',
                ],
                [
                    'title'       => 'Handle percentage discount display for vendor-created coupons to correctly show as percentage instead of fixed amount.',
                    'description' => '',
                ],
                [
                    'title'       => 'Dokan PayPal Marketplace payment gateway not appearing during product Advertisement checkout.',
                    'description' => '',
                ],
            ],
        ],
    ...
    [
        ...
        'changes'  => [
            'New Feature' => [
                [
                    'title'       => 'Add Block Checkout integration for Stripe Express payments.',
                    'description' => '',
                ],
                [
                    'title'       => 'Implemented unified payment token handling across checkout modes and enabled multiple card support configurable from the Stripe Express dashboard.',
                    'description' => '',
                ],
            ],
            'Improvement' => [
                [
                    'title'       => 'Refactor Dokan CAPTCHA service and add CAPTCHA support to the Store Support login popup.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improve Stripe Express gateway settings with clearer test environment options (Live/Test/Sandbox).',
                    'description' => '',
                ],
                [
                    'title'       => 'Enhance subscription/recurring payment handling during checkout.',
                    'description' => '',
                ],
            ],
            'Fix' => [
                [
                    'title'       => 'Resolve incorrect coupon error message when a vendor coupon is used with admin products.',
                    'description' => '',
                ],
                [
                    'title'       => 'Ensure User Subscription renew correctly when Dokan is enabled.',
                    'description' => '',
                ],
                [
                    'title'       => 'Prevent Stripe Express webhook timestamp type mismatch issue.',
                    'description' => '',
                ],
                [
                ...
                [
                    'title'       => 'Stripe Express connection check to require both charges and payouts to be enabled.',
                    'description' => '',
                ],
            ],
        ],
    ...
    [
        ...
        'changes'  => [
            'Improvement' => [
                [
                    'title'       => 'Apply updated DokanModal support to vendor support tickets.',
                    'description' => '',
                ],
                [
                    'title'       => 'Apply REST API restrictions on manual order availability for vendors and vendor staff.',
                    'description' => '',
                ],
                [
                    'title'       => 'Display trial period details on vendor subscription screens.',
                    'description' => '',
                ],
                [
                    'title'       => 'Show current billing period start and end dates for recurring subscriptions.',
                    'description' => '',
                ],
            ],
            'Fix' => [
                [
                    'title'       => 'Incorrect API key field for Dokan Stripe Sandbox and Test mode selection.',
                    'description' => '',
                ],
                [
                ...
                [
                    'title'       => 'Show unread live chat message count in the vendor dashboard inbox.',
                    'description' => '',
                ],
                [
                    'title'       => 'Prevent PHP warning for missing payment key in custom withdrawal methods.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improve Dokan AI Image Enhancer service to prevent enhancer error.',
                    'description' => '',
                ],
            ],
        ],
    ...
    [
        ...
        'changes'  => [
            'New' => [
                [
                    'title'       => 'Added order fee details and refund support to Logs API and Reports UI.',
                    'description' => '',
                ],
            ],
            'Improvement' => [
                [
                    'title'       => 'Enhanced Delivery Time with modern UI for a better user experience.',
                    'description' => '',
                ],
                [
                    'title'       => 'Added Order reference ID on Admin support ticket list table and ticket details page.',
                    'description' => '',
                ],
                [
                    'title'       => 'Add a user-friendly message for duplicate comment when admin replays in a ticket.',
                    'description' => '',
                ],
                [
                    'title'       => 'Filter reset option on Vendor dashboard and Admin dashboard support tickets list table.',
                    'description' => '',
                ],
                [
                    'title'       => 'Added options "Mark as read" and "Mark as unread" on admin support ticket bulk action.',
                    'description' => '',
                ],
                [
                    'title'       => 'Added Order reference ID on Vendor support ticket list table.',
                    'description' => '',
                ],
                [
                    'title'       => 'Vendor Subscription exclusive for admin only support added.',
                    'description' => '',
                ],
                [
                    'title'       => 'Fixed coupon validation to correctly apply discounts when products or their parent variations are explicitly included, ensuring consistent eligibility across vendor rules.',
                    'description' => '',
                ],
                [
                    'title'       => 'Conditionally hide the commission details in product listing, order listing, order details page for Dokan subscription product and Dokan advertisement product.',
                    'description' => '',
                ],
            ],
            'Fix' => [
                [
                    'title'       => 'Fixed admin commission for recurring vendor subscriptions when paid via Stripe Express.',
                    'description' => '',
                ],
                [
                    'title'       => 'Enhance withdraw schedule handling and improve data safety.',
                    'description' => '',
                ],
                [
                    'title'       => 'Vendor shipping placeholder costs not being supported in the updated Dashboard.',
                    'description' => '',
                ],
                [
                ...
                [
                    'title'       => 'Generate and apply coupons for bulk discounts when cart item quantities are updated.',
                    'description' => '',
                ],
                [
                    'title'       => 'Ensure bulk discount coupons apply consistently across both blocks and classic cart pages.',
                    'description' => '',
                ],
                [
                    'title'       => 'Explicitly define nullable parameter types in Customer::map_data() for PHP 8.4 compatibility.',
                    'description' => '',
                ],
                [
                    'title'       => 'Currency always showing USD in vendor panel dashboard and report section.',
                    'description' => '',
                ],
                [
                    'title'       => 'Store opening and closing times were not saving correctly when the site language was not English.',
                    'description' => '',
                ],
                [
                    'title'       => 'PHP 8.4 deprecation warnings in Stripe Express checkout flow.',
                    'description' => '',
                ],
                [
                    'title'       => 'Explicitly define nullable parameter types in Payment::generate_data() for PHP 8.4 compatibility.',
                    'description' => '',
                ],
                [
                    'title'       => 'Subscription cancellation shows error message despite successful cancellation.',
                    'description' => '',
                ],
                [
                    'title'       => 'Corrected coupon "Minimum Amount" field to properly save values with localized decimal separators.',
                    'description' => '',
                ],
                [
                    'title'       => 'ArgumentCountError in bulk edit product brands by ensuring correct argument count for the action hook.',
                    'description' => '',
                ],
                [
                    'title'       => 'Prevent payment processing conflicts in guest checkout by temporarily disabling locking mechanism.',
                    'description' => '',
                ],
            ],
        ],
    ...
    [
        ...
        'changes'  => [
            'Fix' => [
                [
                    'title'       => 'Resolved an issue where Elementor Pro version 3.32.0 creates error.',
                    'description' => '',
                ],
            ],
        ],
    ...
    [
        ...
        'changes'  => [
            'Improvement' => [
                [
                    'title'       => 'Add dynamic social profile fields with URL validation and improved UI.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improve error message for unsupported vendor country in Dokan PayPal Marketplace setup.',
                    'description' => '',
                ],
                [
                    'title'       => 'Rank Math SEO section is now supported on vendor dashboard product forms for Booking and Auction products.',
                    'description' => '',
                ],
                [
                    'title'       => 'Move subscription email settings to WooCommerce for better consistency.',
                    'description' => '',
                ],
            ],
            'Fix' => [
                [
                    'title'       => 'Prevent potential errors for manual order actions controller.',
                    'description' => '',
                ],
                [
                    'title'       => 'Resolve store subscription settings typo error in current subscription header.',
                    'description' => '',
                ],
                [
                    'title'       => 'Use standardize ui classes for product addon image buttons.',
                    'description' => '',
                ],
                [
                    'title'       => 'Add support for decimal-less currencies in PayPal integration.',
                    'description' => '',
                ],
                [
                    'title'       => 'Update shipping zone link to conditionally navigate to old settings page.',
                    'description' => '',
                ],
                [
                    'title'       => 'Resolve test email functionality error for subscription cancelled notification template.',
                    'description' => '',
                ],
            ],
        ],
    ...
    [
        ...
        'changes'  => [
            'Improvement' => [
                [
                    'title'       => 'Updated the user interface of the vendor dashboard Product Review page.',
                    'description' => '',
                ],
                [
                    'title'       => 'Added an option in gateway settings to disconnect all connected vendors when MangoPay credentials are changed.',
                    'description' => '',
                ],
                [
                    'title'       => 'Updated the user interface of the vendor dashboard Product Q&A page.',
                    'description' => '',
                ],
                [
                    'title'       => 'Added translation support for analytics report scripts to improve internationalization (i18n).',
                    'description' => '',
                ],
                [
                    'title'       => 'Enabled script translations for the Table Rate Shipping module in the vendor dashboard app.',
                    'description' => '',
                ],
            ],
            'Fix' => [
                [
                    'title'       => 'The commission meta box will now be hidden for orders that include product advertisements.',
                    'description' => '',
                ],
                [
                    'title'       => 'Resolved fatal error in abuse report admin email by removing unnecessary timestamp conversion.',
                    'description' => '',
                ],
                [
                    'title'       => 'Resolved broken order links in vendor dashboard reports that were redirecting to incorrect or non-existent order detail pages.',
                    'description' => '',
                ],
                [
                    'title'       => 'Adjusted zero amount order handling in Stripe Connect payment processing.',
                    'description' => '',
                ],
                [
                    'title'       => 'Enforced ownership validation when updating vendor staff so only the current vendor can modify their own staff records.',
                    'description' => '',
                ],
            ],
        ],
