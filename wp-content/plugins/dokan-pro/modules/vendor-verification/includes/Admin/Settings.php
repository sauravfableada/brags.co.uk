...
class Settings {
    ...
    public function __construct() {
        add_filter( 'dokan_settings_sections', [ $this, 'settings_sections' ] );
        add_filter( 'dokan_settings_fields', [ $this, 'settings_fields' ] );
    }
    ...
    public function settings_sections( $sections ): array {
        $sections[] = [
            ...
            'document_link'        => 'https://dokan.co/docs/wordpress/modules/dokan-seller-verification-admin-settings/',
            'settings_title'       => __( 'Vendor Verification Settings', 'dokan' ),
            'settings_description' => __( 'You can authenticate your vendors by authorizing vendors to connect their social profiles to their storefront.',
                'dokan' ),
        ];
        $sections[] = [
            ...
            'settings_description' => __( 'You can integrate SMS gateways to verify the contact information of the vendor.',
                'dokan' ),
        ];
    ...
    public function settings_fields( $settings_fields ): array {
        ...
        $settings_fields['dokan_verification'] = [
            'verified_icon'                      => [
                'name'    => 'verified_icon',
                'type'    => 'icon-radio',
                'options' => Helper::get_verified_icons(),
                'default' => 'check_circle_solid',
                'label'   => __( 'Verified Icon', 'dokan' ),
                'desc'    => __( 'Choose your preferred icon for verified stores in the marketplace.', 'dokan' ),
            ],
            'vendor_verification_documents'      => [
                'name'        => 'vendor_verification_methods',
                'type'        => 'verification_methods',
                'label'       => __( 'Verification Methods', 'dokan' ),
                'description' => __( 'Manage the verification methods vendors can use.', 'dokan' ),
            ],
            'vendor_verification_social_section' => [
                'name'          => 'vendor_verification_social_section',
                'type'          => 'sub_section',
                'label'         => __( 'Social Connect', 'dokan' ),
                'description'   => __( 'You can authenticate your vendors by authorizing vendors to connect their social profiles to their storefront.', 'dokan' ),
            ...
            'facebook_app_details'               => [
                ...
                'facebook_app_label'  => [
                    ...
                    'desc'         => sprintf(
                    /* translators: 1) Opening anchor tag, 2) Closing anchor tag */
                        __( '%1$sCreate an App%2$s. If you don\'t have one and fill App ID and Secret below.',
                            'dokan' ),
                ...
                'facebook_app_id'     => [
                    ...
                    'type'         => 'text',
                    'tooltip'      => __( 'You can get it from Facebook Developer platform -> Login -> Select  "Add A New App" -> Collect App ID.',
                        'dokan' ),
                    'social_field' => true,
                ],
                'facebook_app_secret' => [
                    ...
                    'type'         => 'text',
                    'tooltip'      => __( 'You can get it from Facebook Developer platform -> Login -> Select  "Add A New App" -> Collect App secret.',
                        'dokan' ),
                    'social_field' => true,
                ],
            ],
            'twitter_app_details'                => [
                ...
                /* translators: 1) Opening anchor tag, 2) Closing anchor tag */
                    ...
                    '<a target="_blank" href="https://dokan.co/docs/wordpress/settings/dokan-social-login/configuring-twitter/">',
                    '</a>'
                ),
                'enable_status'      => [
                ...
                'twitter_app_label'  => [
                    ...
                    'desc'         => sprintf(
                    /* translators: 1) Opening anchor tag, 2) Closing anchor tag */
                        __( 'If you don\'t have one and fill Consumer key and Secret below. %1$sCreate an App%2$s',
                            'dokan' ),
                ...
                'twitter_app_id'     => [
                    ...
                    'type'         => 'text',
                    'tooltip'      => __( 'You can get it from Twitter Developer platform -> Login -> Select  "Create an App" -> Input URL & integrate Twitter with Dokan. Go to "Keys and Tokens" -> View Keys -> Collect API key and use as Consumer Key.',
                        'dokan' ),
                    'social_field' => true,
                ],
                'twitter_app_secret' => [
                    ...
                    'type'         => 'text',
                    'tooltip'      => __( 'You can get it from Twitter Developer platform -> Login -> Select  "Create an App" -> Input URL & integrate Twitter with Dokan. Go to "Keys and Tokens" -> View Keys -> Collect API secret and use as Consumer secret.',
                        'dokan' ),
                    'social_field' => true,
                ],
            ],
            'google_app_details'                 => [
                ...
                'social_desc'       => __( 'You can successfully connect to your Google account with your website.',
                    'dokan' ),
                'google_app_label'  => [
                    ...
                    'desc'         => sprintf(
                    /* translators: 1) Opening anchor tag, 2) Closing anchor tag */
                        __( 'If if you don\'t have one and fill Client ID and Secret below. %1$sCreate an App%2$s',
                            'dokan' ),
                ...
                'google_app_url'    => [
                    ...
                    'type'         => 'html',
                    'tooltip'      => __( 'Your store URL, which will be required in syncing with Google API.',
                        'dokan' ),
                    'social_field' => true,
                ],
                'google_app_id'     => [
                    ...
                    'type'         => 'text',
                    'tooltip'      => __( 'You can get it from Google Console Platform -> Google+API -> Enable -> Manage -> Credentials -> Create Credentials -> OAuth client ID -> Web Application -> Fill in the information & click Create. A pop up will show "Client ID".',
                        'dokan' ),
                    'social_field' => true,
                ],
                'google_app_secret' => [
                    ...
                    'type'         => 'text',
                    'tooltip'      => __( 'You can get it from Google Console Platform -> Google+API -> Enable -> Manage -> Credentials -> Create Credentials -> OAuth client ID -> Web Application -> Fill in the information & click Create. A pop up will show "Client Credentials".',
                        'dokan' ),
                    'social_field' => true,
                ],
            ],
            'linkedin_app_details'               => [
                ...
                'linkedin_app_label'  => [
                    ...
                    'desc'         => sprintf(
                    /* translators: 1) Opening anchor tag, 2) Closing anchor tag */
                        __( 'If you don\'t have one and fill Client ID and Secret below. %1$sCreate an App%2$s',
                            'dokan' ),
                ...
                'linkedin_app_id'     => [
                    ...
                    'label'        => __( 'Client ID', 'dokan' ),
                    'type'         => 'text',
                    'tooltip'      => __( 'You can get it from LinkedIn Developers platform -> Create an App -> Fill necessary info -> Click "Create app" -> "Auth" section -> Collect Client ID.',
                        'dokan' ),
                    'social_field' => true,
                ],
                'linkedin_app_secret' => [
                    ...
                    'label'        => __( 'Client Secret', 'dokan' ),
                    'type'         => 'text',
                    'tooltip'      => __( 'You can get it from LinkedIn Developers platform -> Create an App -> Fill necessary info -> Click "Create app" -> "Auth" section -> Collect Client Secret.',
                        'dokan' ),
                    'social_field' => true,
                ],
            ],
        ...
        $settings_fields['dokan_verification_sms_gateways'] = [
            ...
            'sms_text'       => [
                ...
                /* translators: 1) Opening strong tag, 2) Closing strong tag */
                    __( 'This will be displayed in SMS. %1$s%%CODE%%%2$s will be replaced by verification code',
                        'dokan' ),
                    '<strong>',
                    '</strong>'
                ),
            ...
            'nexmo_details'  => [
                ...
                'type'           => 'social',
                'enable_status'  => [
                    'name'    => 'nexmo_enable_status',
                    'default' => 'on',
                ],
                'icon_url'       => DOKAN_PRO_PLUGIN_ASSEST . '/images/scl-icons/vonage.svg',
                'social_desc'    => __( 'You can successfully connect to your Vonage account and log in from here.',
                    'dokan' ),
                'nexmo_header'   => [
                    'name'         => 'nexmo_header',
                    'type'         => 'html',
                    'desc'         => sprintf(
                    /* translators: 1) Opening anchor tag, 2) Closing anchor tag */
                        __( 'Configure your gateway from %1s here %2s and fill the details below', 'dokan' ),
                ...
                'nexmo_username' => [
                    ...
                    'tooltip'      => __( 'You can get it from https://www.vonage.com/ -> Create an Account -> Collect Key.',
                        'dokan' ),
                    'social_field' => true,
                ],
                'nexmo_pass'     => [
                    ...
                    'type'         => 'text',
                    'tooltip'      => __( 'You can get it from https://www.vonage.com/ -> Create an Account -> Collect Secret.',
                        'dokan' ),
                    'social_field' => true,
                ],
                'show_if'        => [
            ...
            'twilio_details' => [
                ...
                'type'             => 'social',
                'enable_status'    => [
                    'name'    => 'twilio_enable_status',
                    'default' => 'on',
                ],
                'icon_url'         => DOKAN_PRO_PLUGIN_ASSEST . '/images/scl-icons/twilio.svg',
                'social_desc'      => __( 'You can successfully connect to your Twilio account and log in from here.',
                    'dokan' ),
                'twilio_header'    => [
                    'name'         => 'twilio_header',
                    'type'         => 'html',
                    'desc'         => sprintf(
                    /* translators: 1) Opening anchor tag, 2) Closing anchor tag */
                        __( 'Configure your gateway from %1$s here %2$s and fill the details below', 'dokan' ),
                ...
                'twilio_username'  => [
                    ...
                    'type'         => 'text',
                    'tooltip'      => __( 'You can get it from https://www.twilio.com/ -> Create an Account -> Collect SID.',
                        'dokan' ),
                    'social_field' => true,
                ],
                'twilio_pass'      => [
                    ...
                    'type'         => 'text',
                    'tooltip'      => __( 'You can get it from https://www.twilio.com/ -> Create an Account -> Collect Token.',
                        'dokan' ),
                    'social_field' => true,
                ],
                'twilio_code_type' => [
