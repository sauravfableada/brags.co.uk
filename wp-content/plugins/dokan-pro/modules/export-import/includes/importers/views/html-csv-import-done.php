...
<div class="wc-progress-form-content woocommerce-importer">
    <section class="woocommerce-importer-done">
        ...
        if ( 0 < $imported_variations ) {
            $results[] = sprintf(
            /* translators: %s: variations count */
                _n( '%s variation imported', '%s variations imported', $imported_variations, 'dokan' ), '<strong>' . number_format_i18n( $imported_variations ) . '</strong>'
            );
        }
