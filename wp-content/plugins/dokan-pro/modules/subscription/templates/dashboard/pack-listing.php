...
<div class="dokan-subscription-content">
    ...
    /**
     * Fires before the subscription packs listing on the vendor dashboard.
     *
     * @since 4.3.2
     *
     * @param object|null $subscription The current vendor subscription object.
     * @param int         $user_id      The current vendor user ID.
     */
    do_action( 'dokan_subscription_packs_before', $subscription, $user_id );
    ?>
    ...
    if ( $subscription_packs->have_posts() ) {
        ...
        <div class="pack_content_wrapper">
            ...
            while ( $subscription_packs->have_posts() ) {
                ...
                <?php
                /**
                 * Fires before each subscription pack item in the listing.
                 *
                 * @since 4.3.2
                 *
                 * @param int    $pack_id  The subscription pack product ID.
                 * @param object $sub_pack The subscription pack object.
                 */
                do_action( 'dokan_subscription_pack_item_before', $pack_id, $sub_pack );
                ?>
                ...
                <div class="product_pack_item <?php echo ( Helper::is_vendor_subscribed_pack( $pack_id ) || Helper::pack_renew_seller( $pack_id ) ) ? 'current_pack ' : ''; ?><?php echo ( $sub_pack->is_trial() && Helper::has_used_trial_pack( get_current_user_id() ) ) ? 'fp_already_taken' : ''; ?>">
                    <?php
                    /**
                     * Fires before the pack price section inside a subscription pack item.
                     *
                     * Plugins like YayCurrency can use this hook to inject a currency
                     * switcher dropdown before the subscription price display.
                     *
                     * @since 4.3.2
                     *
                     * @param int    $pack_id  The subscription pack product ID.
                     * @param object $sub_pack The subscription pack object.
                     */
                    do_action( 'dokan_subscription_pack_before_price', $pack_id, $sub_pack );
                    ?>
                    ...
                    <?php
                    /**
                     * Fires after the pack price section inside a subscription pack item.
                     *
                     * @since 4.3.2
                     *
                     * @param int    $pack_id  The subscription pack product ID.
                     * @param object $sub_pack The subscription pack object.
                     */
                    do_action( 'dokan_subscription_pack_after_price', $pack_id, $sub_pack );
                    ?>
                    ...
                    <?php
                    /**
                     * Fires at the end of a subscription pack item, inside the item container.
                     *
                     * @since 4.3.2
                     *
                     * @param int    $pack_id  The subscription pack product ID.
                     * @param object $sub_pack The subscription pack object.
                     */
                    do_action( 'dokan_subscription_pack_item_content_after', $pack_id, $sub_pack );
                    ?>
                </div><!-- .product_pack_item -->

                <?php
                /**
                 * Fires after each subscription pack item in the listing.
                 *
                 * @since 4.3.2
                 *
                 * @param int    $pack_id  The subscription pack product ID.
                 * @param object $sub_pack The subscription pack object.
                 */
                do_action( 'dokan_subscription_pack_item_after', $pack_id, $sub_pack );
                ?>
                <?php
            }
            ?>
    ...
    /**
     * Fires after the subscription packs listing on the vendor dashboard.
     *
     * @since 4.3.2
     *
     * @param object|null $subscription The current vendor subscription object.
     * @param int         $user_id      The current vendor user ID.
     */
    do_action( 'dokan_subscription_packs_after', $subscription, $user_id );
    ?>
