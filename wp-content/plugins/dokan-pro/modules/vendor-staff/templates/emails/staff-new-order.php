...
<h2>
    ...
    echo wp_kses_post( $before . sprintf( __( '[Order #%s]', 'dokan' ) . $after . ' (<time datetime="%s">%s</time>)', $order->get_order_number(), wc_format_datetime($order->get_date_created()), wc_format_datetime( $order->get_date_created() ) ) );
    ?>
</h2>
