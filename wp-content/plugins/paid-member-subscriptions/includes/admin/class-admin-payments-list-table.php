...
Class PMS_Payments_List_Table extends WP_List_Table {
    ...
    public function column_username( $item ) {
        ...
        if ( pms_current_user_can_access_area( 'pms-payments-page' ) && $item['status'] === 'completed' && !empty( $payment->payment_gateway ) && pms_payment_gateways_support( array( $payment->payment_gateway ), 'refunds' ) )
