                    ...
                    <div class="cozmoslabs-form-field-wrapper">
                        ...
                        <div id="payment-actions">
                            ...
                            <?php if ( !empty( $transaction_url ) ) : ?>
                                ...
                                <?php if( pms_current_user_can_access_area( 'pms-payments-page' ) && $payment_status === 'completed' && !empty( $payment->payment_gateway ) && pms_payment_gateways_support( array( $payment->payment_gateway ), 'refunds' ) ) : ?>
