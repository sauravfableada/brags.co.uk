 ...
 */
import "./editor.scss";
import PMSBlockContentRestrictionControlsCommon, { getRestrictionHelpMessage } from "../../../block-content-restriction/src/controls.js";
...
const Edit = (props) => {
    let helpMessage = "";
    if ( props.attributes.pmsContentRestriction ) {
        const subscriptionPlans = typeof pmsBlockEditorDataBlockContentRestriction !== 'undefined' 
            ? pmsBlockEditorDataBlockContentRestriction.subscriptionPlans 
            : [];
        helpMessage = getRestrictionHelpMessage( props.attributes.pmsContentRestriction, subscriptionPlans );
    }
    ...
    if (props.attributes.cover) {
        ...
        return (
            <>
                ...
                <div {...useBlockProps()}>
                    <div className="pms-content-restriction-start-container" style={{ flexDirection: 'column' }}>
                        ...
                        { helpMessage && (
                            <div style={{ marginTop: '10px', fontSize: '13px', color: '#666', textAlign: 'center', maxWidth: '400px' }}>
                                {helpMessage}
                            </div>
                        ) }
                    </div>
